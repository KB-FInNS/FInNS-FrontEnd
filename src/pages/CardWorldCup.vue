  ...
  const cards = ref([
    {
      ...
      image: 'src/assets/media/avatars/American Express Blue Card.png', // 첫 번째 카드 이미지 경로 설정
      description: [
        '대중교통 10% 할인',
        '생활서비스 5% 할인',
        'KB Pay 이용 시 생활서비스 5% 추가 할인',
      ],
    ...
    },
    {
      ...
      image: 'src/assets/media/avatars/American Express Blue Card.png', // 두 번째 카드 이미지 경로 설정
      description: [
        '우리를 위한 5% 할인(선택형)',
        '두리(소중한 당신)를 위한 10% 할인(선택형)',
        '통신료 10% 할인은 기본',
      ],
