    ...
    <div class="card-body pt-9 pb-0">
      ...
      <div class="d-flex flex-wrap flex-sm-nowrap">
        ...
        <div class="me-7 mb-4" style="margin-left: 110px">
          ...
          <img
            :src="getMbtiAvatar(member.mbtiType)"
            alt="MBTI Profile Picture"
          />
        </div>
        <!--end::Pic-->
      ...
      <div>
        ...
        >
          쇼핑몰에 가면 눈에<br />
          보이는 건 전부 내 꺼!<br />
          최신 유행 아이템부터 <br />희귀템까지 쇼핑 카트는 <br />언제나 가득 차
          있다!
        </p>
        ...
        <p
          ...
          class="text-gray-800 fw-semibold fs-2 mt-1 pt-5 mb-7 text-center"
        >
          최신 휴대폰과 초고속 <br />인터넷 없인 못 사는 <br />유형! 데이터와
          통신비 <br />절약을 위해 소비 습관을 <br />길러보자!!
        </p>
        ...
        >
          ...
          주된 <br />지출이며, 경제적이고 <br />빠른 이동을 추구하는
          <br />실속파.
        </p>
        ...
        <p
          ...
          class="text-gray-800 fw-semibold fs-2 mt-1 pt-5 mb-7 text-center"
        >
          당신만의 특별한 <br />MBTI를 가진 캐릭터입니다! 자신의 색깔을
          <br />확실하게 표현하는 성격이군요.
        </p>
      </div>
    </div>
            ...
            <div class="card-back bg-Two">
              <div class="card-body p-3">
                ...
                >
                  쇼핑몰에 가면 눈에<br />
                  보이는 건 전부 내 꺼!<br />
                  최신 유행 아이템부터 <br />희귀템까지 쇼핑 카트는 언제나 가득
                  차 있다!
                </p>
              </div>
            </div>
          ...
          <div class="card">
            ...
            <div class="card-back bg-Three">
              <div class="card-body p-3">
                ...
                >
                  외모와 건강 관리를 최우선으로 생각하는 사람!<br />
                  최신 뷰티 제품과 고급 <br />서비스를 위해선 <br />아낌없이
                  투자하는 <br />유형이다!!
                </p>
              </div>
            </div>
            ...
            <div class="card-back bg-six">
              <div class="card-body p-3">
                ...
                <p
                  class="text-gray-800 fw-semibold fs-2 mt-1 pt-5 mb-7 text-center"
                >
                  대중교통을 애용하는 <br />뚜벅초형!! 지하철, 버스, 택시 등
                  교통비가 주된 <br />지출이며, 경제적이고 <br />빠른 이동을
                  추구하는 <br />실속파.
                </p>
              </div>
            </div>
...
<<<<<<< HEAD
                ...
                >
                  <img
                    src="../../assets/media/avatars/study.png"
                    height="220px"
                  />
=======
            ...
            <div class="card-back bg-nine">
              <div class="card-body p-3">
                ...
                <p
                  class="text-gray-800 fw-semibold fs-2 mt-1 pt-5 mb-7 text-center"
                >
                  술과 유흥을 즐기는 <br />당신!! 술자리와 유흥비가 가장 큰
                  지출이며, <br />언제나 즐거운 시간을 <br />추구하는 캐릭터.
                </p>
              </div>
            </div>
          </div>
