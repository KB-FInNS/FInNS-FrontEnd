<template>
  <!-- <div class="justify-content-center align-items-center text-center bg-title">
    ...
    <Banner titleText="예금 상품" descriptionText="자신에게 맞는 조건을 선택하여 맞춤 예금 상품을 확인해보세요." />
    <!-- 탭 -->
    <div class="m-5">
        ...
        <div class="card mb-10">
          ...
          <div class="m-5 mb-1 ms-10">
            <div class="col-lg-6">
              ...
              <div class="nav-group nav-group-fluid">
                <label v-for="(intType, index) in interestTypes" :key="index">
          ...
          <div class="m-5 mb-1 ms-10">
            ...
            <div class="d-flex">
              <div class="form-check form-check-custom form-check-solid mb-5 me-5"
                v-for="(member, index) in memberOptions" :key="index">
                <input v-model="selectedMember" class="form-check-input" type="checkbox"
                  :id="'deposit_search_Membery_' + index" :value="member.value" />
                <label class="form-check-label flex-grow-1 fw-semibold fs-6"
                  ...
                  :for="'deposit_search_Membery_' + index">
                  {{ member.label }}
                </label>
              </div>
            </div>
          ...
          <div class="m-5 mb-1 ms-10">
            ...
            <div class="d-flex">
              <div class="form-check form-check-custom form-check-solid mb-5 me-5"
                ...
                <input v-model="selectedJoinWay" :value="joinWay.value" class="form-check-input" type="checkbox"
                  :id="'deposit_search_category_' + index"
                  @click="joinWay.value === '전체' ? toggleAllJoinWays() : null" />
                <label class="form-check-label flex-grow-1 fw-semibold fs-6"
                  :class="{ 'selected-color': selectedJoinWay.includes(joinWay.value), 'default-color': !selectedJoinWay.includes(joinWay.value) }"
                  :for="'deposit_search_category_' + index">
                  {{ joinWay.label }}
                </label>
              </div>
            </div>
