      ...
      <div class="card mb-10">
        ...
        <div class="card-body">
            <div class="d-flex align-items-center">
                <div class="position-relative w-md-400px me-md-2">
                    ...
                    <input v-model="searchDeposit" type="text" class="form-control form-control-solid ps-10" placeholder="예금 상품명을 입력해주세요.">
                </div>
                <div class="d-flex align-items-center">
                    <button @click="searchDepositData" type="submitSearch" class="btn btn-primary me-5">검색</button>
                </div>
            </div>
        </div>
        ...
        <div class="m-5 mb-1 ms-10">
          <div class="col-lg-6">
            ...
            <div class="nav-group nav-group-fluid">
              ...
              >
              <label
                ><input v-model="selectedPeriod" type="radio" class="btn-check" name="depositPeriod" value="1" /><span class="btn btn-sm btn-color-muted btn-active btn-active-primary fw-bold px-4"
                  >1개월</span
                ></label
              >
              <label
                ><input v-model="selectedPeriod" type="radio" class="btn-check" name="depositPeriod" value="3" /><span class="btn btn-sm btn-color-muted btn-active btn-active-primary fw-bold px-4"
                  >3개월</span
                ></label
              > 
              <label
                ><input v-model="selectedPeriod" type="radio" class="btn-check" name="depositPeriod" value="12" /><span class="btn btn-sm btn-color-muted btn-active btn-active-primary fw-bold px-4"
                  >1년</span
                ></label
              >
              <label
                ><input v-model="selectedPeriod" type="radio" class="btn-check" name="depositPeriod" value="24" /><span class="btn btn-sm btn-color-muted btn-active btn-active-primary fw-bold px-4"
                  >2년</span
                ></label
              >
              <label
                ><input v-model="selectedPeriod" type="radio" class="btn-check" name="depositPeriod" value="36" /><span class="btn btn-sm btn-color-muted btn-active btn-active-primary fw-bold px-4"
                  >3년</span
                ></label
              >
            </div>
        ...
        <div class="m-5 mb-1 ms-10">
          <div class="col-lg-6">
            ...
            <div class="nav-group nav-group-fluid">
              ...
              >
              <label
                ><input v-model="selectedInttype" type="radio" class="btn-check" value="단리" /><span class="btn btn-sm btn-color-muted btn-active btn-active-primary fw-bold px-4"
                  >단리</span
                ></label
              >
              <label
                ><input v-model="selectedInttype" type="radio" class="btn-check" value="복리" /><span
                  class="btn btn-sm btn-color-muted btn-active btn-active-primary fw-bold px-4"
                  >복리</span
                ></label
              >
        ...
        <div class="m-5 mb-1 ms-10">
          ...
          <div class="d-flex">
            ...
            <div class="form-check form-check-custom form-check-solid mb-5 me-5">
              <input v-model="selectedJoinWay" value="영업점" class="form-check-input" type="checkbox" id="deposit_search_category_2"/>
              <label class="form-check-label flex-grow-1 fw-semibold text-gray-700 fs-6" for="deposit_search_category_2">영업점</label>
            </div>
            <div class="form-check form-check-custom form-check-solid mb-5 me-5">
              <input v-model="selectedJoinWay" value="인터넷" class="form-check-input" type="checkbox" id="deposit_search_category_3"/>
              <label class="form-check-label flex-grow-1 fw-semibold text-gray-700 fs-6" for="deposit_search_category_3">인터넷</label>
            </div>
            <div class="form-check form-check-custom form-check-solid mb-5 me-5">
              <input v-model="selectedJoinWay" value="스마트폰" class="form-check-input" type="checkbox" id="deposit_search_category_4"/>
              <label class="form-check-label flex-grow-1 fw-semibold text-gray-700 fs-6" for="deposit_search_category_4">스마트폰</label>
            </div>
            <div class="form-check form-check-custom form-check-solid mb-5 me-5">
              <input v-model="selectedJoinWay" value="모집인" class="form-check-input" type="checkbox" id="deposit_search_category_5"/>
              <label class="form-check-label flex-grow-1 fw-semibold text-gray-700 fs-6" for="deposit_search_category_5">모집인</label>
            </div>
            <div class="form-check form-check-custom form-check-solid mb-5 me-5">
              <input v-model="selectedJoinWay" value="전화(텔레뱅킹)" class="form-check-input" type="checkbox" id="deposit_search_category_6"/>
...
const sortedDataList = computed(() => {
  ...
  if (selectedSort.value === 'intr_rate2Desc') {
    return data.sort((a, b) => parseFloat(b.intr_rate2) - parseFloat(a.intr_rate2));
  }
  return data;
});

// 검색 함수
const searchDepositData = () => {
  console.log('검색 실행: ', searchDeposit.value);
};
