<template>
    <div id="kt_aside" class="aside aside-default aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside"
        ...
        <div class="aside-menu flex-column-fluid ps-3 pe-1">
            ...
            <div class="menu menu-sub-indention menu-column menu-rounded menu-title-gray-600 menu-active-bg menu-arrow-gray-500 fw-semibold fs-3 my-5 mt-lg-2 mb-lg-0"
                ...
                <div class="hover-scroll-y mx-4" id="kt_aside_menu_wrapper" data-kt-scroll="false"
                    ...
                    <div class="menu-item mt-5">
                        ...
                        <router-link class="menu-link" to="/search" exact-active-class="active">
                            <span class="menu-icon svg-icon svg-icon-2hx" style="color: black;">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
