        ...
        <div class="hover-scroll-y mx-4" id="kt_aside_menu_wrapper" data-kt-scroll="false"
          ...
          <div class="menu-item mt-5">
            ...
            <router-link class="menu-link" to="/search" exact-active-class="active">
              <span class="menu-icon svg-icon svg-icon-2hx" style="color: grey">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="menu-item mt-5">
            <!--begin:Menu link-->
            <router-link class="menu-link" to="/postDetails" exact-active-class="active">
              <span class="menu-icon svg-icon svg-icon-muted svg-icon-2hx" style="color: violet">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
              ...
              <div v-for="(item, index) in products" :key="index" class="recommendation-card">
                ...
                <div class="card-content pt-12">
                  ...
                  <p>
                    ...
                    |
                    <router-link :to="item.link2">{{ item.linkText2 }}</router-link>
                  </p>
                </div>
              </div>
            </div>
