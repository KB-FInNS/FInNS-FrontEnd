...
const users = ref([
  { id: 1, name: 'Melody Macy', initial: 'M', isFollowing: false },
  { id: 2, name: 'John Doe', initial: 'J', isFollowing: false },
  { id: 3, name: 'Alice Smith', initial: 'A', isFollowing: false },
  { id: 4, name: 'Bob Johnson', initial: 'B', isFollowing: false },
  { id: 5, name: 'Carol White', initial: 'C', isFollowing: false },
  { id: 6, name: 'David Brown', initial: 'D', isFollowing: false },
  { id: 7, name: 'Eve Davis', initial: 'E', isFollowing: false },
  { id: 8, name: 'Frank Miller', initial: 'F', isFollowing: false },
  { id: 9, name: 'Grace Wilson', initial: 'G', isFollowing: false },
  { id: 10, name: 'Henry Moore', initial: 'H', isFollowing: false },
]);
